...
# 20 "eg_memory_usage.c" 2
# 1 "/usr/include/sys/sysinfo.h" 1 3 4
# 25 "/usr/include/sys/sysinfo.h" 3 4
...
# 65 "eg_memory_usage.c"
   err = 0;

  *residentMemoryMB = ( (double) get_phys_pages() );
# 80 "eg_memory_usage.c"
}
...
(double *residentMemoryMB)
{
  ...
  getrusage(RUSAGE_SELF, &info);
# 122 "eg_memory_usage.c"
  *residentMemoryMB = ( (double) get_phys_pages() );
# 134 "eg_memory_usage.c"
}
