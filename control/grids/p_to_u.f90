...
!     at u points, on both the new dynamics and endgame grids
!
...
SUBROUTINE p_to_u(array_on_p_points,                              &
                  ini_start,ini_end,                              &
                  inj_start,inj_end,                              &
                  outi_start,outi_end,                            &
                  outj_start,outj_end,                            &
...
IF (lhook) CALL dr_hook('P_TO_U',zhook_in,zhook_handle)
...
IF (lhook) CALL dr_hook('P_TO_U',zhook_out,zhook_handle)
RETURN
