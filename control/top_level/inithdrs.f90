...
CHARACTER(LEN=80), INTENT(OUT)  ::  cmessage  !  Error return message
...
INTEGER :: n1       ! Packing Indicator for Lookup(21)
...
!
IF (lhook) CALL dr_hook('INITHDRS',zhook_in,zhook_handle)
r_eqv_rmdi = rmdi
...
! DEPENDS ON: set_dumpfile_address
  CALL set_dumpfile_address(a_fixhd, len_fixhd,                   &
                            ...
                            disk_address)
 9999 CONTINUE
IF (lhook) CALL dr_hook('INITHDRS',zhook_out,zhook_handle)
RETURN
