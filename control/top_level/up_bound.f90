...
! ARGBND Control data calculated from NAMELIST-
     ...
     &                  ICODE,CMESSAGE)
      ...
      USE um_input_control_mod,  ONLY:                                  &
           l_int_uvw_lbc,     l_dust_div1_lbc,    l_dust_div2_lbc,      &
           l_dust_div3_lbc,   l_dust_div4_lbc,    l_dust_div5_lbc,      &
           l_dust_div6_lbc,                                             &
           l_so2,             l_so2_lbc,          l_dms,                &
           l_dms_lbc,         l_so4_aitken,       l_so4_aitken_lbc,     &
           l_so4_accu,        l_so4_accu_lbc,     l_so4_diss,           &
           l_so4_diss_lbc,    l_nh3,              l_nh3_lbc,            &
           l_soot_new,        l_soot_new_lbc,     l_soot_agd,           &
           l_soot_agd_lbc,    l_soot_cld,         l_soot_cld_lbc,       &
           l_bmass_new,       l_bmass_new_lbc,    l_bmass_agd,          &
           l_bmass_agd_lbc,   l_bmass_cld,        l_bmass_cld_lbc,      &
           l_ocff_new,        l_ocff_new_lbc,     l_ocff_agd,           &
           l_ocff_agd_lbc,    l_ocff_cld,         l_ocff_cld_lbc,       &
           l_nitr_acc,        l_nitr_acc_lbc,     l_nitr_diss,          &
           l_nitr_diss_lbc,   l_soot,             l_ocff,               &
           model_domain 
...
! --------------------------------------------------------------------
      ...
      IF (lhook) CALL dr_hook('UP_BOUND',zhook_in,zhook_handle)
      ICODE=0
      CMESSAGE=' '
...
! DEPENDS ON: read_atmos_lbcs
     ...
     &      MODEL_LEVELS,WET_LEVELS,TR_LBC_VARS,TR_LEVELS,TR_LBC_UKCA,  &
     ...
     &      D1(JW_ADV_LBC), D1(JMURK_LBC),                              &
     &      D1(JDUST_DIV1_LBC), D1(JDUST_DIV2_LBC), D1(JDUST_DIV3_LBC), &
     &      D1(JDUST_DIV4_LBC), D1(JDUST_DIV5_LBC), D1(JDUST_DIV6_LBC), &
     &      D1(JSO2_LBC), D1(JDMS_LBC), D1(JSO4_AITKEN_LBC),            &
     &      D1(JSO4_ACCU_LBC),D1(JSO4_DISS_LBC), D1(JNH3_LBC),          &
     &      D1(JSOOT_NEW_LBC), D1(JSOOT_AGD_LBC), D1(JSOOT_CLD_LBC),    &
     &      D1(JBMASS_NEW_LBC), D1(JBMASS_AGD_LBC), D1(JBMASS_CLD_LBC), &
     &      D1(JOCFF_NEW_LBC), D1(JOCFF_AGD_LBC), D1(JOCFF_CLD_LBC),    &
     &      D1(JNITR_ACC_LBC), D1(JNITR_DISS_LBC),                      &
     &      D1(JTRACER_LBC(1)),  D1(JTR_UKCA_LBC(1)),                   &
     &      ICODE,CMESSAGE)
...
! DEPENDS ON: read_atmos_lbcs
     ...
     &    D1(JDUST_DIV1_LBC_TEND), D1(JDUST_DIV2_LBC_TEND),             &
     &    D1(JDUST_DIV3_LBC_TEND), D1(JDUST_DIV4_LBC_TEND),             &
     &    D1(JDUST_DIV5_LBC_TEND), D1(JDUST_DIV6_LBC_TEND),             &
     &    D1(JSO2_LBC_TEND), D1(JDMS_LBC_TEND),                         &
     &    D1(JSO4_AITKEN_LBC_TEND),                                     &
     &    D1(JSO4_ACCU_LBC_TEND), D1(JSO4_DISS_LBC_TEND),               &
     &    D1(JNH3_LBC_TEND), D1(JSOOT_NEW_LBC_TEND),                    &
     &    D1(JSOOT_AGD_LBC_TEND), D1(JSOOT_CLD_LBC_TEND),               &
     &    D1(JBMASS_NEW_LBC_TEND), D1(JBMASS_AGD_LBC_TEND),             &
     &    D1(JBMASS_CLD_LBC_TEND), D1(JOCFF_NEW_LBC_TEND),              &
     &    D1(JOCFF_AGD_LBC_TEND), D1(JOCFF_CLD_LBC_TEND),               &
     &    D1(JNITR_ACC_LBC_TEND), D1(JNITR_DISS_LBC_TEND),              &
     &    D1(JTRACER_LBC_TEND(1)), D1(JTR_UKCA_LBC_TEND(1)),            &
     &    ICODE,CMESSAGE)
...
! DEPENDS ON: increment_atmos_lbcs
     ...
     &        D1(JDUST_DIV1_LBC),D1(JDUST_DIV1_LBC_TEND),               &
     &        D1(JDUST_DIV2_LBC),D1(JDUST_DIV2_LBC_TEND),               &
     &        D1(JDUST_DIV3_LBC),D1(JDUST_DIV3_LBC_TEND),               &
     &        D1(JDUST_DIV4_LBC),D1(JDUST_DIV4_LBC_TEND),               &
     &        D1(JDUST_DIV5_LBC),D1(JDUST_DIV5_LBC_TEND),               &
     &        D1(JDUST_DIV6_LBC),D1(JDUST_DIV6_LBC_TEND),               &
     &        D1(JSO2_LBC),D1(JSO2_LBC_TEND),                           &
     &        D1(JDMS_LBC),D1(JDMS_LBC_TEND),                           &
     &        D1(JSO4_AITKEN_LBC),D1(JSO4_AITKEN_LBC_TEND),             &
     &        D1(JSO4_ACCU_LBC),D1(JSO4_ACCU_LBC_TEND),                 &
     &        D1(JSO4_DISS_LBC),D1(JSO4_DISS_LBC_TEND),                 &
     &        D1(JNH3_LBC),D1(JNH3_LBC_TEND),                           &
     &        D1(JSOOT_NEW_LBC),D1(JSOOT_NEW_LBC_TEND),                 &
     &        D1(JSOOT_AGD_LBC),D1(JSOOT_AGD_LBC_TEND),                 &
     &        D1(JSOOT_CLD_LBC),D1(JSOOT_CLD_LBC_TEND),                 &
     &        D1(JBMASS_NEW_LBC),D1(JBMASS_NEW_LBC_TEND),               &
     &        D1(JBMASS_AGD_LBC),D1(JBMASS_AGD_LBC_TEND),               &
     &        D1(JBMASS_CLD_LBC),D1(JBMASS_CLD_LBC_TEND),               &
     &        D1(JOCFF_NEW_LBC),D1(JOCFF_NEW_LBC_TEND),                 &
     &        D1(JOCFF_AGD_LBC),D1(JOCFF_AGD_LBC_TEND),                 &
     &        D1(JOCFF_CLD_LBC),D1(JOCFF_CLD_LBC_TEND),                 &
     &        D1(JNITR_ACC_LBC),D1(JNITR_ACC_LBC_TEND),                 &
     &        D1(JNITR_DISS_LBC),D1(JNITR_DISS_LBC_TEND),               &
     &        D1(JTRACER_LBC(1)),D1(JTRACER_LBC_TEND(1)),               &
     &        D1(JTR_UKCA_LBC(1)),D1(JTR_UKCA_LBC_TEND(1)),             &
     &        RIM_STEPSA,                                               &
     &        ICODE)
...
! 2.1 Read atmosphere lateral boundary fields, general update step
      ...
      IF (.NOT.first_atm_call .AND. I_AO == 1) THEN
        ...
        IF (MOD(steps_from_bdi_start + STEPim(a_im),                    &
                                                     ! LBC update step
     &          RIM_STEPSA) == 0 ) THEN
...
! 2.1.4  Increment lookup header to start of next update period
 ...
 9999 CONTINUE
      IF (lhook) CALL dr_hook('UP_BOUND',zhook_out,zhook_handle)
      RETURN
