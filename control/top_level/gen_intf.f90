...
!LL          for each area on this timestep and calls GEN_INTF_A 
!LL          to generate the interface data.
!LL
!LL Programing standard: UM Documentation paper No. 3, Version 8.3
!LL
...
! Number of dust bins in input dump/output LBCs
...
!  Set up internal model identifier and STASH index
      IF (lhook) CALL dr_hook('GEN_INTF',zhook_in,zhook_handle)
...
!     Determine if interface data required this timestep
     ...
     &      .AND. STEPim(a_im) <= INTERFACE_LSTEPim(JINTF,a_im) ) THEN
               ...
               ! Always print out this information to make sure LBCs are
               ! generated at the correct time.
               WRITE (6,'(A,I9,A,I2)') 'Gen_Intf: Timestep ',STEPim(a_im), &
...
!         Reinitialised files are closed in Gen_Intf
 ...
 9999 CONTINUE
      IF (lhook) CALL dr_hook('GEN_INTF',zhook_out,zhook_handle)
      RETURN
