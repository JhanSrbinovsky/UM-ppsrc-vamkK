...
IF (lhook) CALL dr_hook('ATM_STEP_PHYS_RESET',zhook_in,zhook_handle)
...
ELSE IF (flag == 'cyclrset') THEN
  ...
  IF ( numcycles > 1 ) THEN
    ...
    IF ( .NOT. l_endgame ) THEN
    ALLOCATE( r_u_phys1(udims%i_start:udims%i_end,                   &
                        udims%j_start:udims%j_end,                   &
                        udims%k_start:udims%k_end) )
    ALLOCATE( r_v_phys1(vdims%i_start:vdims%i_end,                   &
                        vdims%j_start:vdims%j_end,                   &
                        vdims%k_start:vdims%k_end) )
    ALLOCATE( thetastar_phys1(tdims%i_start:tdims%i_end,             &
                              tdims%j_start:tdims%j_end,             &
                              tdims%k_start:tdims%k_end) )
    ALLOCATE( qstar_phys1(qdims%i_start:qdims%i_end,                 &
                          qdims%j_start:qdims%j_end,                 &
                          qdims%k_start:qdims%k_end) )
    ALLOCATE( qclstar_phys1(qdims%i_start:qdims%i_end,               &
                            qdims%j_start:qdims%j_end,               &
                            qdims%k_start:qdims%k_end) )
    ALLOCATE( qcfstar_phys1(qdims%i_start:qdims%i_end,               &
                            qdims%j_start:qdims%j_end,               &
                            qdims%k_start:qdims%k_end) )

    IF (l_mcr_qcf2)  ALLOCATE( qcf2_star_phys1  (qdims%i_start:qdims%i_end,   &
                                                 qdims%j_start:qdims%j_end,   &
                                                 qdims%k_start:qdims%k_end) )
    IF (l_mcr_qrain) ALLOCATE( qrain_star_phys1 (qdims%i_start:qdims%i_end,   &
                                                 qdims%j_start:qdims%j_end,   &
                                                 qdims%k_start:qdims%k_end) )
    IF (l_mcr_qgraup)ALLOCATE( qgraup_star_phys1(qdims%i_start:qdims%i_end,   &
                                                 qdims%j_start:qdims%j_end,   &
                                                 qdims%k_start:qdims%k_end) )

    IF ( l_mix_ratio ) THEN
      ALLOCATE ( mix_v_star_phys1(qdims%i_start:qdims%i_end,         &
                                  qdims%j_start:qdims%j_end,         &
                                  qdims%k_start:qdims%k_end) )
      ALLOCATE ( mix_cl_star_phys1(qdims%i_start:qdims%i_end,        &
                                   qdims%j_start:qdims%j_end,        &
                                   qdims%k_start:qdims%k_end) )
      ALLOCATE ( mix_cf_star_phys1(qdims%i_start:qdims%i_end,        &
                                   qdims%j_start:qdims%j_end,        &
                                   qdims%k_start:qdims%k_end) )
      IF ( l_mcr_qcf2  ) ALLOCATE (mix_cf2_star_phys1                &
                                  (qdims%i_start:qdims%i_end,        &
                                   qdims%j_start:qdims%j_end,        &
                                   qdims%k_start:qdims%k_end) )
      IF ( l_mcr_qrain ) ALLOCATE (mix_rain_star_phys1               & 
                                  (qdims%i_start:qdims%i_end,        &
                                   qdims%j_start:qdims%j_end,        &
                                   qdims%k_start:qdims%k_end) ) 
      IF ( l_mcr_qgraup) ALLOCATE (mix_graup_star_phys1              &
                                  (qdims%i_start:qdims%i_end,        &
                                   qdims%j_start:qdims%j_end,        &
                                   qdims%k_start:qdims%k_end) )
    END IF
    ...
    ALLOCATE( area_cld_frac_phys1(qdims%i_start:qdims%i_end,         &
                                  qdims%j_start:qdims%j_end,         &
                                  qdims%k_start:qdims%k_end) )
    ALLOCATE( bulk_cld_frac_phys1(qdims%i_start:qdims%i_end,         &
                                  qdims%j_start:qdims%j_end,         &
                                  qdims%k_start:qdims%k_end) )
    ALLOCATE( bulk_cld_liq_phys1 (qdims%i_start:qdims%i_end,         &
                                  qdims%j_start:qdims%j_end,         &
                                  qdims%k_start:qdims%k_end) )
    ALLOCATE( bulk_cld_fr_phys1  (qdims%i_start:qdims%i_end,         &
                                  qdims%j_start:qdims%j_end,         &
                                  qdims%k_start:qdims%k_end) )
...
END IF  ! Flag
IF (lhook) CALL dr_hook('ATM_STEP_PHYS_RESET',zhook_out,zhook_handle)
RETURN
