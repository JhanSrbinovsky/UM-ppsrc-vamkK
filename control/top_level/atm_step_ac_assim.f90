...
USE bl_option_mod, ONLY: l_use_bl_diag_term
...
IF (lhook) CALL dr_hook('ATM_STEP_AC_ASSIM',zhook_in,zhook_handle)
...
! conveniently as 2-d arrays (and halos not required)
  ...
  ALLOCATE ( work_q  (qdims%i_start:qdims%i_end,        &
                      qdims%j_start:qdims%j_end,        &
                                  1:qdims%k_end) )
  ALLOCATE ( work_qcl(qdims%i_start:qdims%i_end,        &
                      qdims%j_start:qdims%j_end,        &
                                  1:qdims%k_end) )
  ALLOCATE ( work_qcf(qdims%i_start:qdims%i_end,        &
                      qdims%j_start:qdims%j_end,        &
                                  1:qdims%k_end) )
...
IF (lhook) CALL dr_hook('ATM_STEP_AC_ASSIM',zhook_out,zhook_handle)
RETURN
