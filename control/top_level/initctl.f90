...
!LL
!LL  PURPOSE: Initialises STASH control arrays from STASH control file.
!LL
!LL  EXTERNAL DOCUMENTATION: UMDP C4
!LL
!LLEND-------------------------------------------------------------
!
...
! ARGD1 end
      ...
      USE ppxlook_mod, ONLY: ppxrecs, ppxc, ppxi, ppxptr
...
!     Initialise STLIST to zero
      ...
      IF (lhook) CALL dr_hook('INITCTL',zhook_in,zhook_handle)
      DO   II = 1,TOTITEMS
        DO IE = 1,LEN_STLIST
          STLIST(IE,II)=0
        END DO
...
!----------------------------------------------------------------------
 9999 CONTINUE
      IF (lhook) CALL dr_hook('INITCTL',zhook_out,zhook_handle)
      RETURN
