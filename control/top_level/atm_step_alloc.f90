...
USE turb_diff_mod, ONLY: qpos_diag_limit, l_qpos_diag_pr, q_pos_method
...
USE dynamics_input_mod, ONLY:  L_mix_ratio,NumCycles,                 &
                               L_new_tdisc

USE um_input_control_mod,  ONLY:                                        &
     model_domain,         l_mr_physics1
...
IF (lhook) CALL dr_hook('ATM_STEP_ALLOC',zhook_in,zhook_handle)
IF (flag == 'alloc_mr' ) THEN 

  ! store physics changes for use in SL_moist_conserve

  IF (L_mix_ratio) THEN
    ALLOCATE ( mix_v (qdims_l%i_start:qdims_l%i_end,                &
                      qdims_l%j_start:qdims_l%j_end,                &
                      qdims_l%k_start:qdims_l%k_end) )
    ALLOCATE ( mix_cl(qdims_l%i_start:qdims_l%i_end,                &
                      qdims_l%j_start:qdims_l%j_end,                &
                      qdims_l%k_start:qdims_l%k_end) )
    ALLOCATE ( mix_cf(qdims_l%i_start:qdims_l%i_end,                &
                      qdims_l%j_start:qdims_l%j_end,                &
                      qdims_l%k_start:qdims_l%k_end) )
    ALLOCATE ( mix_v_star (qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end) )
    ALLOCATE ( mix_cl_star(qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end) ) 
    ALLOCATE ( mix_cf_star(qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end) )
    IF(L_mcr_qcf2)THEN
      ALLOCATE ( mix_cf2  (qdims_l%i_start:qdims_l%i_end,           &
                           qdims_l%j_start:qdims_l%j_end,           &
                           qdims_l%k_start:qdims_l%k_end) )
      ALLOCATE ( mix_cf2_star(qdims_s%i_start:qdims_s%i_end,        &
                              qdims_s%j_start:qdims_s%j_end,        &
                              qdims_s%k_start:qdims_s%k_end) )
    ELSE
    ...
    END IF
    IF(L_mcr_qrain)THEN
      ALLOCATE ( mix_rain     (qdims_l%i_start:qdims_l%i_end,       &
                               qdims_l%j_start:qdims_l%j_end,       &
                               qdims_l%k_start:qdims_l%k_end) )
      ALLOCATE ( mix_rain_star(qdims_s%i_start:qdims_s%i_end,       &
                               qdims_s%j_start:qdims_s%j_end,       &
                               qdims_s%k_start:qdims_s%k_end) )
    ELSE
    ...
    IF(L_mcr_qgraup)THEN
      ALLOCATE ( mix_graup     (qdims_l%i_start:qdims_l%i_end,      &
                                qdims_l%j_start:qdims_l%j_end,      &
                                qdims_l%k_start:qdims_l%k_end) ) 
      ALLOCATE ( mix_graup_star(qdims_s%i_start:qdims_s%i_end,      &
                                qdims_s%j_start:qdims_s%j_end,      &
                                qdims_s%k_start:qdims_s%k_end) )
    ELSE
...
! DEPENDS ON: calc_mix_star
    CALL calc_mix_star(row_length, rows, wet_levels,                  &
  ...
  ! store physics changes for use in Sl_moist_conserve
  IF (L_moist_nonhydro_conserve .AND. ErrorStatus == 0 ) THEN

    ! At this point q_star holds the increment to q
    IF (l_mix_ratio) THEN
      ALLOCATE ( mix_v_phys1 (qdims_s%i_start:qdims_s%i_end,         &
                              qdims_s%j_start:qdims_s%j_end,         &
                              qdims_s%k_start:qdims_s%k_end) )
      ALLOCATE ( mix_cl_phys1(qdims_s%i_start:qdims_s%i_end,         &
                              qdims_s%j_start:qdims_s%j_end,         &
                              qdims_s%k_start:qdims_s%k_end) )
      ALLOCATE ( mix_cf_phys1(qdims_s%i_start:qdims_s%i_end,         &
                              qdims_s%j_start:qdims_s%j_end,         &
                              qdims_s%k_start:qdims_s%k_end) )
      IF (L_mcr_qcf2) THEN
        ALLOCATE(mix_cf2_phys1(qdims_s%i_start:qdims_s%i_end,        &
                               qdims_s%j_start:qdims_s%j_end,        &
                               qdims_s%k_start:qdims_s%k_end) )  
      ELSE
      ...
      IF (L_mcr_qrain) THEN
        ALLOCATE(mix_rain_phys1(qdims_s%i_start:qdims_s%i_end,       &
                                qdims_s%j_start:qdims_s%j_end,       &
                                qdims_s%k_start:qdims_s%k_end) )
      ELSE
      ...
      IF (L_mcr_qgraup) THEN
        ALLOCATE(mix_graup_phys1(qdims_s%i_start:qdims_s%i_end,      &
                                 qdims_s%j_start:qdims_s%j_end,      &
                                 qdims_s%k_start:qdims_s%k_end) )
      ELSE
...
! DEPENDS ON: calc_mix_star
    ...
    ELSE
      ...
      ALLOCATE ( q_phys1  (qdims_s%i_start:qdims_s%i_end,              &
                           qdims_s%j_start:qdims_s%j_end,              &
                           qdims_s%k_start:qdims_s%k_end) )
      ALLOCATE ( qcl_phys1(qdims_s%i_start:qdims_s%i_end,              &
                           qdims_s%j_start:qdims_s%j_end,              &
                           qdims_s%k_start:qdims_s%k_end) )
      ALLOCATE ( qcf_phys1(qdims_s%i_start:qdims_s%i_end,              &
                           qdims_s%j_start:qdims_s%j_end,              &
                           qdims_s%k_start:qdims_s%k_end) ) 
      ...
      IF (L_mcr_qcf2) THEN
        ALLOCATE (qcf2_phys1(qdims_s%i_start:qdims_s%i_end,          &
                             qdims_s%j_start:qdims_s%j_end,          &
                             qdims_s%k_start:qdims_s%k_end) )
        DO k = qdims_s%k_start, qdims_s%k_end
          DO j = qdims_s%j_start, qdims_s%j_end
            DO i = qdims_s%i_start, qdims_s%i_end
      ...
      IF (L_mcr_qrain) THEN
        ALLOCATE (qrain_phys1 (qdims_s%i_start:qdims_s%i_end,         &
                               qdims_s%j_start:qdims_s%j_end,         &
                               qdims_s%k_start:qdims_s%k_end) )
        DO k = qdims_s%k_start, qdims_s%k_end
          DO j = qdims_s%j_start, qdims_s%j_end
      ...
      IF (L_mcr_qgraup) THEN
        ALLOCATE (qgraup_phys1 (qdims_s%i_start:qdims_s%i_end,        &
                                qdims_s%j_start:qdims_s%j_end,        &
                                qdims_s%k_start:qdims_s%k_end) )
        DO k = qdims_s%k_start, qdims_s%k_end
          DO j = qdims_s%j_start, qdims_s%j_end
      ...
      ! Mixing ratio variables need to be allocated too as they are 
      ! used in a subroutine call (ni_sl_moist) 
       ALLOCATE(mix_v_phys1    (1,1,1)) 
       ALLOCATE(mix_cl_phys1   (1,1,1)) 
       ALLOCATE(mix_cf_phys1   (1,1,1)) 
       ALLOCATE(mix_cf2_phys1  (1,1,1)) 
       ALLOCATE(mix_rain_phys1 (1,1,1)) 
       ALLOCATE(mix_graup_phys1(1,1,1)) 
  ...
  ELSE IF ( NumCycles > 1 .AND. L_pc2 .AND. ErrorStatus == 0 ) THEN
...
ELSE IF (flag == 'MixRatio') THEN
 ...
 ! Convert to mixing ratios from specific humidities if needed
  ...
  ! Allocate q_store variables
    ALLOCATE ( q_store  (qdims_l%i_start:qdims_l%i_end,              &
                         qdims_l%j_start:qdims_l%j_end,              &
                         qdims_l%k_start:qdims_l%k_end) )
    ALLOCATE ( qcl_store(qdims_l%i_start:qdims_l%i_end,              &
                         qdims_l%j_start:qdims_l%j_end,              &
                         qdims_l%k_start:qdims_l%k_end) )
    ALLOCATE ( qcf_store(qdims_l%i_start:qdims_l%i_end,              &
                         qdims_l%j_start:qdims_l%j_end,              &
                         qdims_l%k_start:qdims_l%k_end) )
    IF (L_mcr_qcf2) THEN
      ALLOCATE ( qcf2_store(qdims_l%i_start:qdims_l%i_end,           &
                            qdims_l%j_start:qdims_l%j_end,           &
                            qdims_l%k_start:qdims_l%k_end) )     
    ELSE
    ...
    END IF
    IF (L_mcr_qrain) THEN
      ALLOCATE ( qrain_store(qdims_l%i_start:qdims_l%i_end,          &
                             qdims_l%j_start:qdims_l%j_end,          &
                             qdims_l%k_start:qdims_l%k_end) )
    ELSE
    ...
    END IF
    IF (L_mcr_qgraup) THEN
      ALLOCATE ( qgraup_store(qdims_l%i_start:qdims_l%i_end,         &
                              qdims_l%j_start:qdims_l%j_end,         &
                              qdims_l%k_start:qdims_l%k_end) )
    ELSE
...
! Allocations required for new time discretisation
  ...
  IF ( l_new_tdisc ) THEN
    ...
    ALLOCATE(theta_np1(tdims_s%i_start:tdims_s%i_end,               &
                       ...
                       tdims_s%k_start:tdims_s%k_end),              &
                       STAT=alloc_stat)
    IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",             &
    ...
    IF ( L_mix_ratio ) THEN
      ...
      ALLOCATE (mix_v_np1( qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end),          &
                           STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      ALLOCATE (mix_cl_np1(qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end),          &
                           STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      ALLOCATE (mix_cf_np1(qdims_s%i_start:qdims_s%i_end,           &
                           qdims_s%j_start:qdims_s%j_end,           &
                           qdims_s%k_start:qdims_s%k_end),          &
                           STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      IF ( L_mcr_qcf2 ) THEN
        ALLOCATE( mix_cf2_np1(qdims_s%i_start:qdims_s%i_end,        &
                              qdims_s%j_start:qdims_s%j_end,        &
                              qdims_s%k_start:qdims_s%k_end),       &
                              STAT=alloc_stat)
        IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",         &
      ...
      IF ( L_mcr_qrain ) THEN
        ALLOCATE( mix_rain_np1(qdims_s%i_start:qdims_s%i_end,       &
                               qdims_s%j_start:qdims_s%j_end,       &
                               qdims_s%k_start:qdims_s%k_end),      &
                               STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      IF ( L_mcr_qgraup ) THEN
        ALLOCATE( mix_graup_np1(qdims_s%i_start:qdims_s%i_end,      &
                                qdims_s%j_start:qdims_s%j_end,      &
                                qdims_s%k_start:qdims_s%k_end),     &
                                STAT=alloc_stat)
        IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",         &
    ...
    ELSE
      ...
      ALLOCATE(q_np1  (qdims_s%i_start:qdims_s%i_end,               &
                       qdims_s%j_start:qdims_s%j_end,               &
                       qdims_s%k_start:qdims_s%k_end),              &
                       STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      ALLOCATE(qcl_np1(qdims_s%i_start:qdims_s%i_end,               &
                       qdims_s%j_start:qdims_s%j_end,               &
                       qdims_s%k_start:qdims_s%k_end),              &
                       STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      ALLOCATE(qcf_np1(qdims_s%i_start:qdims_s%i_end,               &
                       qdims_s%j_start:qdims_s%j_end,               &
                       qdims_s%k_start:qdims_s%k_end),              &
                       STAT=alloc_stat)
      IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",           &
      ...
      IF ( L_mcr_qcf2 ) THEN
        ALLOCATE(qcf2_np1(qdims_s%i_start:qdims_s%i_end,           &
                          qdims_s%j_start:qdims_s%j_end,           &
                          qdims_s%k_start:qdims_s%k_end),          &
                          STAT=alloc_stat)
        IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",        &
      ...
      IF ( L_mcr_qrain ) THEN
        ALLOCATE(qrain_np1(qdims_s%i_start:qdims_s%i_end,          &
                           qdims_s%j_start:qdims_s%j_end,          &
                           qdims_s%k_start:qdims_s%k_end),         &
                           STAT=alloc_stat)
        IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",        &
      ...
      IF ( L_mcr_qgraup ) THEN
        ALLOCATE(qgraup_np1(qdims_s%i_start:qdims_s%i_end,         &
                            qdims_s%j_start:qdims_s%j_end,         &
                            qdims_s%k_start:qdims_s%k_end) ,       &
                            STAT=alloc_stat)
        IF (alloc_stat.ne.0) CALL Ereport("ATM_STEP_ALLOC",        &
...
! End of Non-ENDGAME code
   ...
   IF ( NumCycles > 1 ) THEN
     ...
     IF (L_mcr_qcf2)   DEALLOCATE( qcf2_star_phys1 )
     IF (L_mcr_qrain)  DEALLOCATE( qrain_star_phys1 )
     IF (L_mcr_qgraup) DEALLOCATE( qgraup_star_phys1 )
     ...
     IF(l_mix_ratio)THEN
       ...
       IF(L_mcr_qcf2)THEN
         DO k = qdims%k_start, qdims%k_end 
           DO j = qdims%j_start, qdims%j_end 
             DO i = qdims%i_start, qdims%i_end 
               mix_cf2(i,j,k) = mix_cf2_phys1(i,j,k) +mix_cf2_phys2(i,j,k)
             END DO
           END DO
         END DO
       END IF
       ...
       IF(L_mcr_qrain)THEN
         DO k = qdims%k_start, qdims%k_end 
           DO j = qdims%j_start, qdims%j_end 
             DO i = qdims%i_start, qdims%i_end 
               mix_rain(i,j,k) = mix_rain_phys1(i,j,k) +mix_rain_phys2(i,j,k)
             END DO
           END DO
         END DO
       END IF
       ...
       IF(L_mcr_qgraup)THEN
         DO k = qdims%k_start, qdims%k_end 
           DO j = qdims%j_start, qdims%j_end 
             DO i = qdims%i_start, qdims%i_end 
               mix_graup(i,j,k) = &
                               mix_graup_phys1(i,j,k) +mix_graup_phys2(i,j,k)
             END DO
           END DO
         END DO
       END IF
...
!CDIR NODEP
       ...
       ! Deallocate the dummy mixing ratio variables 
       DEALLOCATE (mix_v_phys1) 
       DEALLOCATE (mix_cl_phys1) 
       DEALLOCATE (mix_cf_phys1) 
       DEALLOCATE (mix_cf2_phys1) 
...
! DEPENDS ON: q_pos_ctl
     CALL Q_Pos_Ctl(QCF, row_length, rows, wet_levels, 1,          &
                    bl_levels, global_row_length, global_rows,     &
                    mype, nproc, halo_i, halo_j, model_domain,     &
                    halo_type_extended, q_pos_method, 0.0,         &
                    l_qpos_diag_pr, qpos_diag_limit,               &
                    'QCF call from atm_step_alloc')
...
END IF ! flag
IF (lhook) CALL dr_hook('ATM_STEP_ALLOC',zhook_out,zhook_handle)
RETURN

END SUBROUTINE Atm_Step_alloc
