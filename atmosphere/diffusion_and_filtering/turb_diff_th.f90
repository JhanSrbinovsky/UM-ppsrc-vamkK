...
!
! Method:
!          Is described in documentation paper 28
!
!
...
! Local arrays
      ...
      , dt_over_r_squared_delz(0:row_length+1, 0:rows+1, levels)        &
      , temp(0:row_length+1, 0:rows+1)                                  &
...
! ----------------------------------------------------------------------
      ...
      IF (lhook) CALL dr_hook('TURB_DIFF_TH',zhook_in,zhook_handle)
...
! DEPENDS ON: swap_bounds
      ...
      IF (lhook) CALL dr_hook('TURB_DIFF_TH',zhook_out,zhook_handle)
      RETURN
