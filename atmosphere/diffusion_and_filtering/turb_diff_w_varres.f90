...
IF (lhook) CALL dr_hook('TURB_DIFF_W_VARRES',zhook_in,zhook_handle)
...
! Section 2.3  Calculate physics increment R_w.
! ----------------------------------------------------------------------
...
IF (lhook) CALL dr_hook('TURB_DIFF_W_VARRES',zhook_out,zhook_handle)
RETURN
END SUBROUTINE turb_diff_w_varres
