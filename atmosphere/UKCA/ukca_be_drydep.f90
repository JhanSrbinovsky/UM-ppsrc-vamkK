...
!     Local variables
      ...
      IF (lhook) CALL dr_hook('UKCA_BE_DRYDEP',zhook_in,zhook_handle)
      DO js = 1, jpspec
      ...
      ENDIF   ! End of IF (L_ukca_intdd) statement

      IF (lhook) CALL dr_hook('UKCA_BE_DRYDEP',zhook_out,zhook_handle)
      RETURN
