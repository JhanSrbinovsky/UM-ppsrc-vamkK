...
! ----------------------------------------------------------------------
      IF (lhook) CALL dr_hook('IDL_INITIAL_DATA',zhook_in,zhook_handle)
...
!----------------------------------------------------------------------
      ...
      Else If (uv_horizfn_number  ==  uv_horiz_ramp) Then
        ...
        ! North pole halo for u, u_adv only 
...
!-------------------------------------------------------------------
     ...
     &              'Settings ======================='
      ...
      IF (lhook) CALL dr_hook('IDL_INITIAL_DATA',zhook_out,zhook_handle)
      RETURN
