...
! Local parameters:
      ...
      PARAMETER (   RoutineName='IDL_NI_INIT_3A')
...
! ----------------------------------------------------------------------
      ...
      IF (lhook) CALL dr_hook('IDL_NI_INIT_3A',zhook_in,zhook_handle)
...
! DEPENDS ON: idl_initial_data_3a
        Call IDL_Initial_data_3a(                                       &
...
! DEPENDS ON: idl_ideal_set_fields_3a
        Call IDL_ideal_set_fields_3a(                                   &
     &              model_domain, row_length, rows, n_rows              &
     &,             model_levels, wet_levels                            &
     &,             offx, offy, halo_i, halo_j                          &
     &,             mype, nproc, at_extremity                           &
...
!----------------------------------------------------------------------
      ...
      IF (lhook) CALL dr_hook('IDL_NI_INIT_3A',zhook_out,zhook_handle)
      RETURN
       END SUBROUTINE IDL_NI_init_3a
