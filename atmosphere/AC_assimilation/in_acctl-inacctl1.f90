...
CHARACTER(LEN=256) :: cmessage     ! OUT: Error return message
...
IF (lhook) CALL dr_hook('IN_ACCTL',zhook_in,zhook_handle)
...
IF (lhook) CALL dr_hook('IN_ACCTL',zhook_out,zhook_handle)
RETURN
