...
REAL, INTENT(IN) ::         &
 ...
 ,delta_smag(np_field)        ! grid size used in smagorinsky length scale
...
CHARACTER (len=12), PARAMETER ::  routinename = 'glue_conv_5a'
!-----------------------------------------------------------------------
...
INTEGER :: n_dp_md  ! number of deep problem points
...
! DEPENDS ON: deep_conv_5a
    CALL deep_conv_5a(                                            &
                 ...
                 rho_theta_dp,rho_dp,r2rho_dp,                    &
                 r2rho_th_dp,dr_across_th_dp, dr_across_rh_dp,    &
                 q_dp,q1_sd_dp,                                   &
...
! DEPENDS ON: shallow_conv_5a
    CALL shallow_conv_5a(                                         &
                     ...
                     r_theta_sh,r_rho_sh,r2rho_th_sh,r2rho_sh,    &
...
! iniialise to zero as not always set
...
IF (lhook) CALL dr_hook('GLUE_CONV_5A',zhook_out,zhook_handle)
RETURN
